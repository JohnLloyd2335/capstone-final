...
class SeniorCitizenController extends Controller
{
    ...
    public function index(Request $request)
    {
        $vaccines = Vaccine::where([
            ['vaccine_category_id', '5'],
            ['status', 'Available'],
            ])->get();

        $immunizations = Immunization::where('immunization_category_id', '5')->with('immunization_category')->orderBy('date_recorded', 'DESC')->get();
        
        return view('senior_immunization.index', compact('vaccines', 'immunizations'));
    }
    ...
    public function store(StoreImmunizationRequest $request)
    {
        ...
        return redirect()->route('senior_citizen_immunizations.index')->with('success', 'Immunization Added Successfully!');
    }
    ...
    public function update(UpdateImmunizationRequest $request, $id)
    {
        ...
        date_default_timezone_set('Asia/Manila');
        $age = Immunization::calculateInfantAge($request->date_of_birth);
        ...
        return redirect()->route('senior_citizen_immunizations.index')->with('success', 'Immunization Edited Successfuly!');
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return redirect()->route('senior_citizen_immunizations.index')->with('success', 'Immunization Successfully Moved to Archive');
    }
    ...
    public function administered(Request $request){
        ...
        return redirect()->route('senior_citizen_immunizations.index')->with('success','Doses Successfully Administered');
    }
    ...
    public function multiAction(Request $request){
        ...
        if(strval($request->actions) === "Archive"){
           ...
           return redirect()->route('senior_citizen_immunizations.index')->with('success', 'Immunizations Successfully Moved to Archive');
